...
var DefaultToneAndFormatting = Preset{
	Name: "DefaultToneAndFormatting",
	Sections: map[SectionType][]Node{
		SectionTone: {
			P("You are professional, direct, and helpful."),
			P("Prefer clarity and correctness over verbosity."),
		},
		SectionFormatting: {
			List(
				Item("Use Markdown for structure"),
				Item("Use fenced code blocks with language hints when showing code"),
				Item("Use '*' bullets and 4-space indentation for nested lists"),
			),
		},
	},
}
