...
func TestReadFileTool_Run(t *testing.T) { //nolint:funlen
	...
	tests := []struct {
		...
		},
		{
			...
			initContent: "test",
			args: tools.Args{
				cat.ParamFilePath:  "invalid_start_test.txt",
				cat.ParamStartLine: -1,
			},
			expectedOutput: "",
			err:            tools.ErrArguments,
		},
		{
			...
			initContent: "test",
			args: tools.Args{
				cat.ParamFilePath: "invalid_end_test.txt",
				cat.ParamEndLine:  -1,
			},
			expectedOutput: "",
			err:            tools.ErrArguments,
		},
		{
			...
			initContent: "test",
			args: tools.Args{
				cat.ParamFilePath:  "end_before_start.txt",
				cat.ParamStartLine: 2,
				cat.ParamEndLine:   1,
			},
			expectedOutput: "",
			err:            tools.ErrArguments,
		},
		{
			...
			initContent: "test1\ntest2\n",
			args: tools.Args{
				cat.ParamFilePath:  "start_beyond_eof_test.txt",
				cat.ParamStartLine: 4,
				cat.ParamEndLine:   6,
			},
			expectedOutput: "",
			err:            tools.ErrArguments,
		},
		{
			...
			initContent: "test1\ntest2",
			args: tools.Args{
				cat.ParamFilePath:  "end_at_eof_test.txt",
				cat.ParamStartLine: 1,
				cat.ParamEndLine:   2,
			},
		...
		},
		{
			...
			initContent: "test1\ntest2",
			args: tools.Args{
				cat.ParamFilePath:  "end_beyond_eof_test.txt",
				cat.ParamStartLine: 1,
				cat.ParamEndLine:   4,
			},
			expectedOutput: "1: test1\n2: test2\n",
		...
		},
		{
			...
			args: tools.Args{
				cat.ParamFilePath: "binary_content_test.txt",
			},
		...
		},
		{
			...
			initContent: "test1\ntest2",
			args: tools.Args{
				cat.ParamFilePath: "full_file_test.txt",
			},
			expectedOutput: "1: test1\n2: test2\n",
			err:            nil,
		},
		{
			...
			initContent: "test1\ntest2\ntest3",
			args: tools.Args{
				cat.ParamFilePath:  "single_line_test.txt",
				cat.ParamStartLine: 2,
				cat.ParamEndLine:   2,
			},
		...
		},
		{
			...
			args: tools.Args{
				cat.ParamFilePath:  "line_num_width_test.txt",
				cat.ParamStartLine: 9,
				cat.ParamEndLine:   11,
			},
		...
		},
		{
			...
			initContent: "test1\ntest2\ntest3\n",
			args: tools.Args{
				cat.ParamFilePath:  "no_end_test.txt",
				cat.ParamStartLine: 2,
			},
			expectedOutput: "2: test2\n3: test3\n",
			err:            nil,
